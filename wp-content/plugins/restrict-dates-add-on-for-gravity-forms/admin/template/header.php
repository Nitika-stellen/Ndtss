    ...
    <div class="pcafe_container">
        <div class="pcafe_header_content">
            <div class="header_logo">
                <img src="<?php echo esc_url(GF_RESTRICT_DATES_ADDON_URL . 'admin/images/logo.svg'); ?>">
                <span>Restrict Dates For Gravity Forms</span>
            </div>
            <p><?php esc_html_e('Restrict which dates are not selectable in your Gravity Forms date picker field.', 'restrict-dates-add-on-for-gravity-forms'); ?></p>
        </div>
    </div>
</div>
        ...
        <ul class="pcafe_menu_wrap">
            <li class="active">
                <a href="#introduction">
                    ...
                    <span><?php esc_html_e('Introduction', 'restrict-dates-add-on-for-gravity-forms'); ?></span>
                </a>
            </li>
            <li>
                <a href="#usage">
                    ...
                    <span><?php esc_html_e('Basic Usage', 'restrict-dates-add-on-for-gravity-forms'); ?></span>
                </a>
            </li>
            <li>
                <a href="#help">
                    ...
                    <span><?php esc_html_e('Help', 'restrict-dates-add-on-for-gravity-forms'); ?></span>
                </a>
            </li>
            <li>
                <a href="#pro">
                    ...
                    <span><?php esc_html_e('Get Pro', 'restrict-dates-add-on-for-gravity-forms'); ?></span>
                </a>
            </li>
            <li>
                <a href="#otherplugins">
                    ...
                    <span><?php esc_html_e('Other Plugins', 'restrict-dates-add-on-for-gravity-forms'); ?></span>
                </a>
            </li>
            <li>
                <a target="_blank" href="https://demo.pluginscafe.com/restrict-dates-for-gravity-forms-pro/" class="demo_btn">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" width="24px" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3 8.25V18a2.25 2.25 0 0 0 2.25 2.25h13.5A2.25 2.25 0 0 0 21 18V8.25m-18 0V6a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 6v2.25m-18 0h18M5.25 6h.008v.008H5.25V6ZM7.5 6h.008v.008H7.5V6Zm2.25 0h.008v.008H9.75V6Z" />
                    </svg>
                    <span><?php esc_html_e('Live Demo', 'restrict-dates-add-on-for-gravity-forms'); ?></span>
                </a>
            </li>
        </ul>
    </div>
